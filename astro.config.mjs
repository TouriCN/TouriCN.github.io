...
// import cloudflare from "@astrojs/cloudflare"; // ❌ 删了，走 GH Pages
  ...
  integrations: [
    ...
    sitemap({
      filter: (page) => {
        ...
        if (p === "/anime/" && !siteConfig.pages.anime) return false;
        return true;
      },
    }),
    mdx(),
